  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage service zones and cleaner assignments
          </p>
        </div>
        ...
        <Card className="p-4">
          ...
          <p className="text-2xl font-bold">
            {zones.reduce(
              (sum, z) =>
                sum +
                z.cleaners.reduce((jobSum, c) => jobSum + c.cleaner._count.jobs, 0),
              0
            )}
          </p>
        </Card>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {zones.map((zone) => {
          const activeCleaners = zone.cleaners.filter(
            (c) => c.cleaner.status === 'active'
          ).length;
          const totalJobs = zone.cleaners.reduce(
            (sum, c) => sum + c.cleaner._count.jobs,
            0
          );
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    ...
                    <p className="text-xs text-gray-500 mt-1">Active Cleaners</p>
                  </div>
                  <div className="text-center p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                ...
                <div>
                  ...
                  {zone.cleaners.length > 0 ? (
                      ...
                      {zone.cleaners.slice(0, 3).map((cz) => (
                        ...
                        >
                          <div className="flex h-6 w-6 items-center justify-center rounded-full bg-primary/10 text-xs font-semibold text-primary">
                            {cz.cleaner.firstName[0]}{cz.cleaner.lastName[0]}
                          </div>
                    ...
                    <p className="text-sm text-gray-400 italic">No cleaners assigned</p>
                  )}
                </div>
